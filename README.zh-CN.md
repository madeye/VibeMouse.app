...
从 [最新发布页](https://github.com/madeye/VibeMouse.app/releases/latest) 下载 VibeMouse-0.2.0.zip，解压后将 `VibeMouse.app` 移动到 `/Applications`。应用已完成 Developer ID 签名和公证，Gatekeeper 不会弹出警告。
